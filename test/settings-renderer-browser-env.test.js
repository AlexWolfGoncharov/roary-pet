...
describe("settings renderer browser environment", () => {
  ...
  it("groups Theme cards and exposes theme import actions in Settings", () => {
    ...
    assert.strictEqual(strings.en.themeImportUserThemeZip, "Import Roary theme package (.zip)");
    ...
    assert.strictEqual(strings.ru.themeImportUserThemeZip, "Импортировать пакет темы Roary (.zip)");
    ...
    assert.strictEqual(strings.uk.themeImportUserThemeZip, "Імпортувати пакет теми Roary (.zip)");
