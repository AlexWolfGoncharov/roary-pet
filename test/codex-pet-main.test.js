...
test("Codex Pet main helpers detect clawd protocol args case-insensitively", () => {
  ...
  assert.deepStrictEqual(
    extractClawdProtocolUrls([
      "Roary://import-pet?url=https%3A%2F%2Fexample.test%2Fpet.json",
      "--flag",
      "https://example.test",
      "roary://import-pet?url=https%3A%2F%2Fexample.test%2Fother.json",
    ]),
    [
      "Roary://import-pet?url=https%3A%2F%2Fexample.test%2Fpet.json",
      "roary://import-pet?url=https%3A%2F%2Fexample.test%2Fother.json",
...
test("Codex Pet import URLs queued before app ready do not flush until explicitly drained", async () => {
  ...
  try {
    ...
    runtime.enqueueImportUrl("roary://import-pet?url=https%3A%2F%2Fexample.test%2Fpet.json");
    ...
    assert.deepStrictEqual(parseCalls, ["roary://import-pet?url=https%3A%2F%2Fexample.test%2Fpet.json"]);
...
test("Codex Pet import queue ignores overlapping flush calls while the first drain is active", async () => {
  ...
  runtime.enqueueImportUrl("roary://import-pet?url=https%3A%2F%2Fexample.test%2Fone.json");
  runtime.enqueueImportUrl("roary://import-pet?url=https%3A%2F%2Fexample.test%2Ftwo.json");
  ...
  assert.deepStrictEqual(parseCalls, ["roary://import-pet?url=https%3A%2F%2Fexample.test%2Fone.json"]);
  ...
  assert.deepStrictEqual(parseCalls, [
    "roary://import-pet?url=https%3A%2F%2Fexample.test%2Fone.json",
    "roary://import-pet?url=https%3A%2F%2Fexample.test%2Ftwo.json",
  ]);
