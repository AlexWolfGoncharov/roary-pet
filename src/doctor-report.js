...
function formatDiagnosticReport(result, meta = {}) {
  ...
  const lines = [
    "# Roary Diagnostic Report",
    "",
    `- Generated: ${generatedAt}`,
    `- Roary version: ${version}`,
  ...
  lines.push(
    "",
    "**Privacy notice**: This report is generated locally. Roary does not upload any data. User paths are replaced with `~`, and Roary app paths are replaced with `[APP]`. The report contains no API keys, tokens, conversation content, or document filenames."
  );
