...
const BUBBLE_STRINGS = {
  ...
  ru: {
    autoAcceptEdits: "Автоматически принимать правки",
    switchToPlanMode: "Переключиться в режим планирования",
    allowInDir: "Разрешить {tool} в {dir}/",
    alwaysAllowRule: "Всегда разрешать `{rule}`",
    alwaysAllow: "Всегда разрешать",
    permissionRequest: "Запрос разрешения",
    allow: "Разрешить",
    deny: "Отклонить",
    alwaysAllowBlanket: "Всегда разрешать (всё)",
    alwaysAllowBlanketTitle: "Предупреждение: правило «always» в opencode автоматически одобряет все последующие вызовы инструментов того же типа в этой сессии (включая rm и подобные деструктивные команды). Правило хранится только в памяти — перезапустите opencode, чтобы отменить его.",
    needsInput: "Требуется ввод",
    goToTerminal: "Перейти в терминал",
    submitAnswer: "Отправить ответ",
    nextQuestion: "Далее",
    previousQuestion: "Назад",
    questionProgress: "{current} / {total}",
    chooseOneOption: "Выберите один вариант",
    chooseAtLeastOneOption: "Множественный выбор, выберите хотя бы один",
    questionLabel: "Вопрос {index}",
    other: "Другое",
    otherPlaceholder: "Введите свой ответ…",
    codexPermission: "Запрос разрешения Codex",
    codexToolApproval: "Одобрение инструмента Codex",
    kimiPermission: "Запрос разрешения Kimi",
    checkKimiTerminal: "Одобрите или отклоните этот запрос в терминале Kimi.",
    gotIt: "Понятно",
    planReview: "Проверка плана",
    approve: "Одобрить",
    reject: "Отклонить",
    tellClaudeWhatToChange: "Предложить изменения",
    planFeedbackPlaceholder: "Что нужно изменить?",
    submitFeedback: "Отправить",
    back: "Назад",
  },
  uk: {
    autoAcceptEdits: "Автоматично приймати правки",
    switchToPlanMode: "Перемкнутися в режим планування",
    allowInDir: "Дозволити {tool} у {dir}/",
    alwaysAllowRule: "Завжди дозволяти `{rule}`",
    alwaysAllow: "Завжди дозволяти",
    permissionRequest: "Запит дозволу",
    allow: "Дозволити",
    deny: "Відхилити",
    alwaysAllowBlanket: "Завжди дозволяти (усе)",
    alwaysAllowBlanketTitle: "Попередження: правило «always» в opencode автоматично схвалює всі наступні виклики інструментів того самого типу в цій сесії (включно з rm та подібними деструктивними командами). Правило зберігається лише в пам’яті — перезапустіть opencode, щоб скасувати його.",
    needsInput: "Потрібен ввід",
    goToTerminal: "Перейти в термінал",
    submitAnswer: "Надіслати відповідь",
    nextQuestion: "Далі",
    previousQuestion: "Назад",
    questionProgress: "{current} / {total}",
    chooseOneOption: "Виберіть один варіант",
    chooseAtLeastOneOption: "Множинний вибір, виберіть хоча б один",
    questionLabel: "Питання {index}",
    other: "Інше",
    otherPlaceholder: "Введіть свою відповідь…",
    codexPermission: "Запит дозволу Codex",
    codexToolApproval: "Схвалення інструмента Codex",
    kimiPermission: "Запит дозволу Kimi",
    checkKimiTerminal: "Схваліть або відхиліть цей запит у терміналі Kimi.",
    gotIt: "Зрозуміло",
    planReview: "Перевірка плану",
    approve: "Схвалити",
    reject: "Відхилити",
    tellClaudeWhatToChange: "Запропонувати зміни",
    planFeedbackPlaceholder: "Що потрібно змінити?",
